...
九座万倍速巨型建筑、满级采矿机与物流站、九种新矿脉，一整条从煤和水通到有机化学的化工链
...
| | |
|---|---|
| **九座巨型建筑** | 建造栏新增一页：天工装配厂、冶铸熔炉、燔石化工厂、锤锻精工厂、观微对撞机、生物温室、熔岩冷却厂、催化反应器、综合化学厂。10000 倍速，12 个传送带口直连，自带行星内物流站；外形是**代码生成**的，九座各不相同。其中两座各有一条额外规矩：**生物温室整座受日照约束**（满日照满产、背光面停工）；**催化反应器会记住床里那批催化剂还剩多少活性**——跑约十分钟就结焦失活，整床吹进待生仓，等再生炉烧完碳送回来 |
...
| **综合化学厂** | 第一台**能跑不止一种配方类型**的机器：化学、电化学、氧化还原三类全接，仍是 10000 倍速。原版「一台机器一种类型」是硬的，突破它改了八处闸门；而它**要吃 1000 台燔石化工厂**，所以那一座是它的前置，不是它的牺牲品 |
...
| **可燃液体发电** | 12 种液体各有**工作温度**，决定一份燃料里有多少真的变成电——**脏的能量密、干净的能量稀**。同一桶原油的四个切段自己就把这条演完了（渣油 12.0 MJ / 500 ℃ ↔ 石脑油 3.0 MJ / 900 ℃） |
