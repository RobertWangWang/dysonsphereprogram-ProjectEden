...
| **可燃液体发电** | 12 种液体各有**工作温度**，决定一份燃料里有多少真的变成电——**脏的能量密、干净的能量稀**——藻油 2.6 MJ / 250 ℃ 到氨 2.6 MJ / 2000 ℃ 之间隔着十二档。（同一桶原油的四个切段则是一条**纯温度梯子**：热值全部相同，只有允许的工作温度从 500 ℃ 排到 900 ℃——每件含碳量一样，燃烧焓就一样） |
